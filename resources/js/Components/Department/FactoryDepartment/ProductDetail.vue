...
<template>
    ...
    <div class="sm:rounded-lg" :class="{'overflow-x-scroll': filteredFactories.length > 0}">
        <TableLayout 
            :headers="headers"
        ...
        >
            <template #tbody>
                <tr class="border-b item" v-for="(factory,index) in filteredFactories" :key="factory.id">
