...
<template>
    <div v-if="users.length > 0">
        ...
        <div
            class="sm:rounded-lg"
            :class="{ 'overflow-x-scroll': filteredUsers.length > 0 }"
        >
            <TableLayout
                :headers="headers"
                :is-admin="$page.props.auth.user.isAdmin"
                :is-department="
                    $page.props.auth.user.department.name === 'ADMIN'
                "
            ...
            >
                <template #tbody>
                    ...
                    >
                        ...
                        <td class="py-4 text-center w-[370px] px-2">
                            {{ user.email }}
                        </td>
                        ...
                        <td class="py-4 space-x-3 text-center">
                            <Link
                                :href="`/adminDepartment/users/${user.id}/edit`"
