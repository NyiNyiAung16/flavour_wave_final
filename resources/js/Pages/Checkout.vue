...
<template>
    <NoBannerLayout :canLogin="canLogin" :can-register="canRegister">
        <div class="py-10">
            <div class="max-w-7xl mx-auto bg-neutral-500 p-3 rounded">
                <h3 class="text-2xl font-semibold border-b py-4">
                    Pre-order Summary
                </h3>
                <div class="w-full border-b pb-5 overflow-hidden">
                    <div
                        class="checkoutMain overflow-y-scroll w-full max-h-[380px]"
                    >
                        <ul class="max-w-5xl mx-auto mt-3 pt-3 space-y-5">
                            <li
                                class="list flex justify-between items-center gap-4 rounded p-3"
                            ...
                            >
                                <div class="flex gap-4 items-center">
                                    <img
                                        ...
                                        width="100"
                                        class="h-[90px] object-cover rounded"
                                        alt="cartimg"
                                    />
                                    <div>
                                ...
                                <div
                                    class="flex gap-x-5 items-center text-black"
                                >
                                    <button
                                        class="bg-slate-100 px-3 py-2 rounded-md"
                                        @click="increase(product.id)"
                                    >
                                        <i class="fa-solid fa-plus"></i>
                                    </button>
                                    <p
                                        class="bg-slate-300 w-[30px] text-center rounded-lg"
                                    >
                                        {{ product.quantity }}
                                    </p>
                                    <button
                                        class="bg-red-700 px-3 py-2 rounded-md text-white"
                                        @click="decrease(product.id)"
                                    >
                                        <i class="fa-solid fa-minus"></i>
                                    </button>
                                    <button
                                        class="bg-red-700 ms-2 px-3 py-2 rounded-md text-white"
