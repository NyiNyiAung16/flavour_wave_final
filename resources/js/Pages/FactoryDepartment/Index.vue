        ...
        <template #header>
            <div class="flex flex-col gap-3">
                ...
                <p
                    class="sideBar"
                    :class="{
                        'active-sideBar': toggleChild === 'createProduct',
                    }"
                ...
                <p
                    ...
                    :class="{
                        'active-sideBar':
                            toggleChild === 'createProductDetails',
                    }"
                ...
                <p
                    class="sideBar"
                    :class="{
                        'active-sideBar': toggleChild === 'createIngredient',
                    }"
                ...
                <p
                    class="sideBar"
                    :class="{
                        'active-sideBar': toggleChild === 'createReceipe',
                    }"
