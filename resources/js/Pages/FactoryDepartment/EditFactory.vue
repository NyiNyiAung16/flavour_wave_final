    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex flex-col gap-3">
                ...
                <p class="sideBar active-sideBar">Edit Product</p>
            </div>
        </template>
        <div class="py-8">
                        ...
                        <div class="space-y-4 max-w-5xl mx-auto">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    class="w-full bg-gray-700 border-none p-2 rounded outline-none resize-none"
                            ...
                            <div>
                                <label
                                    class="mb-1 text-gray-50 hover:text-gray-300 duration-150 block bg-gray-700 border-none p-2 rounded cursor-pointer"
                                    for="image"
